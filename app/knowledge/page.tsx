...
export default async function KnowledgePage() {
  ...
  return <div className="space-y-6"><div className="flex flex-wrap items-center justify-between gap-3"><h1 className="text-3xl font-bold">Knowledge library</h1><div className="flex flex-wrap gap-2"><Link href="/knowledge/packages" className="rounded-full border border-emerald-200 px-5 py-2 font-semibold text-emerald-900">Knowledge packages</Link><Link href="/knowledge/import" className="rounded-full border border-emerald-200 px-5 py-2 font-semibold text-emerald-900">Import knowledge</Link><Link href="/knowledge/registry" className="rounded-full bg-emerald-700 px-5 py-2 font-semibold text-white">Knowledge registry</Link></div></div><Library files={files} base="/knowledge" /></div>;
}
